...
#define rate rate__KATP 
#define states states__KATP 
...
#define v _p[8]
#define _g _p[9]
#define _ion_atpi	*_ppvar[0]._pval
...
extern Memb_func* memb_func;
 ...
 "rate_KATP", _hoc_rate,
 "trap0_KATP", _hoc_trap0,
 0, 0
};
#define trap0 trap0_KATP
 extern double trap0( _threadargsprotocomma_ double , double , double , double );
 /* declare global and static user variables */
#define ap ap_KATP
 double ap = 3;
#define athf athf_KATP
 double athf = 0.006;
#define at at_KATP
 double at = 10;
#define q10 q10_KATP
 double q10 = 2.3;
#define qdeltat qdeltat_KATP
 double qdeltat = 1;
...
static void nrn_alloc(Prop* _prop) {
 ...
 prop_ion = need_memb(_atp_sym);
 nrn_promote(prop_ion, 1, 0);
 	_ppvar[0]._pval = &prop_ion->param[1]; /* atpi */
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 0, "atp_ion");
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 KATP /Users/dis006/Box Sync/T6 BP NEURON SIM/V3/Calcium_NMODL/MahapatraEtAl2018/x86_64/KATP.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "KATP channel ";
...
static int  rate ( _threadargsprotocomma_ double _latpi ) {
   double _la , _lqt ;
 _lqt = pow( q10 , ( ( celsius - 37.0 ) / 10.0 ) ) ;
   oinf = ( 1.0 / ( 1.0 + ( pow( ( _latpi / athf ) , ap ) ) ) ) ;
   if ( _latpi < 0.005 ) {
     tauo = 1.0 - ( 186.67 * _latpi ) / _lqt ;
     }
   else {
     tauo = 2.0 / _lqt ;
     }
...
static void _ode_matsol(_NrnThread* _nt, _Memb_list* _ml, int _type) {
 ...
 static void _update_ion_pointer(Datum* _ppvar) {
   nrn_update_ion_pointer(_atp_sym, _ppvar, 0, 1);
